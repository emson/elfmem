...
OVERVIEW: str = "\n".join([
    ...
    "  rescore(max_count?)    LLM call     Deep-sleep: re-evaluate aged active blocks vs current SELF",
    ...
    "",
    "Four rhythms:   remember() [heartbeat] → dream() [breathing] → curate() [sleep] → rescore() [deep sleep]",
